...
(function ($) {
     ...
     */
        ...
        _start = function () {
            ...
            var ngHref = selectedOpts["ng-href"] || (obj.nodeName ? $(obj).attr('ng-href') : obj["ng-href"]) || null;
            href = (!ngHref) ? selectedOpts.href || (obj.nodeName ? $(obj).attr('href') : obj.href) || null : ngHref;
            ...
            if (selectedOpts.type) {
                ...
                else if (href.match(imgRegExpdatauri)) {
                    type = 'image2';
                }
